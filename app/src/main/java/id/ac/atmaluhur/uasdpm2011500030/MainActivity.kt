...
class MainActivity : AppCompatActivity() {
    private lateinit var adpCampuss: AdapterDataCampuss
    private lateinit var dataCampuss: ArrayList<DataCampuss>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adpCampuss = AdapterDataCampuss(this@MainActivity, dataCampuss)

        lvCampuss.adapter = adpCampuss

        refresh()
        btnTambah.setOnClickListener {
            val i = Intent(this@MainActivity, EntryDataCampuss::class.java)
            startActivity(i)
        }
    }
